        ...
        <section className={classes["intro-section"]}>
          <div className="container">
            ...
            <p className={classes["intro-p"]}>
              Learn by doing, challenge yourself, and collaborate with coders
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 col-lg-3 mb-4">
                <Link
                  ...
                  <div className={`card ${classes["feature-item"]} h-100`}>
                    <i
                      className={`fas fa-brain ${classes["feature-icon"]}`}></i>
              ...
              <div className="col-12 col-md-6 col-lg-3 mb-4">
                <Link
                  ...
                  <div className={`card ${classes["feature-item"]} h-100`}>
                    <i
                      className={`fas fa-users ${classes["feature-icon"]}`}></i>
